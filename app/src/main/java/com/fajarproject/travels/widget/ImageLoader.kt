package com.fajarproject.travels.widget
...
class ImageLoader (context: Context)  {
    ...
    init {
        ...
        executorService = Executors.newFixedThreadPool(5, Util.ImageThreadFactory())
        handler = Handler()
    ...
    inner class PhotosLoader(private var imageRequest: ImageRequest) : Runnable {
        ...
        override fun run() {
            ...
            val bitmap = Util.downloadBitmapFromURL(imageRequest.imgUrl)
