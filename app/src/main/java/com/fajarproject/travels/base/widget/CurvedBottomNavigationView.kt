...
class CurvedBottomNavigationView : BottomNavigationView {
	...
	private val curveCircleRadius = 256 / 2
	...
	override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
		...
		mPath?.reset()
		mPath?.moveTo(0.toFloat(), 0.toFloat())
		...
		mPath?.lineTo(mNavigationBarWidth.toFloat(), 0.toFloat())
		mPath?.lineTo(mNavigationBarWidth.toFloat(), mNavigationBarHeight.toFloat())
		mPath?.lineTo(0.toFloat(), mNavigationBarHeight.toFloat())
		mPath?.close()
	}
