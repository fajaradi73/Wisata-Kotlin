...
import com.fajarproject.travels.databinding.AdapterPopulerBinding
...
import com.fajarproject.travels.ui.popularWisata.PopularWisataPresenter
import com.fajarproject.travels.util.Constant
import com.fajarproject.travels.util.Util
import com.like.LikeButton
import com.like.OnLikeListener

class PopularWisataAdapter(
	private val list: MutableList<PopularWisataModel>,
	private val context: Context,
	private val presenter: PopularWisataPresenter?
) :
	...
	override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
		if (holder.itemViewType == Constant.VIEW_TYPE_ITEM) {
            val binding = AdapterPopulerBinding.bind(holder.itemView)
			...
			binding.txtRatting.text = tour.ratting.toString()
			binding.whitelist.isLiked = tour.favorite!!
