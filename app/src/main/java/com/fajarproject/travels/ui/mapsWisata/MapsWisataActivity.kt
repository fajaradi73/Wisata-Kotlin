...
import com.fajarproject.travels.databinding.ActivityMapsTravelsBinding
...
class MapsWisataActivity : MvpActivity<MapsWisataPresenter>(),MapsWisataView, OnMapReadyCallback,
    ...
    private lateinit var binding : ActivityMapsTravelsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapsTravelsBinding.inflate(layoutInflater)
    ...
    override fun init() {
        ...
        binding.btnDirection.setOnClickListener { showIntAds() }
    }
    ...
    override fun loadingDirection(isShow: Boolean) {
        if (isShow){
            binding.progressDirection.visibility = View.VISIBLE
            binding.llDirection.visibility = View.GONE
        }else{
            binding.progressDirection.visibility = View.GONE
            binding.llDirection.visibility = View.VISIBLE
        }
    }
